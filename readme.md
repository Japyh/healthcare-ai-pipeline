...
Example:
```bash
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin <your_number>.dkr.ecr.us-east-1.amazonaws.com
```
Docker Tag Examples
```bash
docker tag healthcare-api:latest <your_number>.dkr.ecr.us-east-1.amazonaws.com/healthcare-api:latest
docker tag healthcare-gradio:latest <your_number>.dkr.ecr.us-east-1.amazonaws.com/healthcare-gradio:latest
```

Docker Push Examples
```bash
docker push <your_number>.dkr.ecr.us-east-1.amazonaws.com/healthcare-api:latest
docker push <your_number>.dkr.ecr.us-east-1.amazonaws.com/healthcare-gradio:latest
```
...
export ECR_REGISTRY=<your_number>.dkr.ecr.us-east-1.amazonaws.com
